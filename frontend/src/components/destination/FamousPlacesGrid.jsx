...
export default function FamousPlacesGrid({ places = [], onAddToPlanner }) {
        ...
        {places.map((place) => (
          ...
          >
            ...
            <div className="relative h-52 w-full overflow-hidden bg-slate-800">
              <img
                src={place.imageUrl || "https://images.unsplash.com/photo-1488646953014-85cb44e25828?auto=format&fit=crop&w=800&q=80"}
                alt={place.name}
                loading="lazy"
                onError={(e) => {
